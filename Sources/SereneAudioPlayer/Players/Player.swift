...
final class Player: NSObject, ObservableObject {
    ...
    var getPercentComplete: Double {
      guard itemDuration > 0 else { return 0 } // Handle cases where total duration is 0
      return (displayTime / itemDuration) * 100
    }
